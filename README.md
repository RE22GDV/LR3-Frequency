...
зокрема, у §6.6 саме воно показує, що шифротекст став невідрізнюваним від
рівномірного. Хі-квадрат же порівнює гістограму з **конкретним** еталоном,
...
| Випадок | Частка випробувань | Формула похибки виконується | Точність правила |
|---|---:|---:|---:|
| максимум єдиний | 76.7 % (1533) | **1533 з 1533** | 65.1 % |
| є нічия за максимумом | 23.4 % (467) | не гарантована | 32.1 % |
...
5. **Наївне правило помиляється систематично**: його похибка дорівнює
   ...
   точність (57.4 % на 40 символах) близька до частки текстів, у яких
   ...
   Якщо максимум єдиний, формула похибки виконується без винятків
   (1533 з 1533 випробувань).

6. **Вимога умови про відсутність статистичних закономірностей
   підтверджується вимірюванням.** Для шифру Цезаря контраст між
   найкращим і найгіршим кандидатом становив 744 (значення відрізнялися
   приблизно у 744 рази), для шифру з випадковим зсувом на кожну
   позицію — лише 2.7, і атака перестала розрізняти кандидатів.
