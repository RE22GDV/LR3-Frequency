...
Реалізовано чотири правила рішення — саме їх порівнює експеримент:
  ...
  * :func:`quadgram_score`   — логправдоподібність за квадриграмами (враховує порядок літер);
  * :func:`most_frequent_rule` — наївне правило «найчастіша літера шифротексту → E».

Окремо наведено :func:`index_of_coincidence`. Це важлива для роботи
метрика з протилежними властивостями: вона ІНВАРІАНТНА щодо зсуву, тому
не здатна визначити ключ, зате виявляє сам факт того, що шифр є
моноалфавітним.
"""
